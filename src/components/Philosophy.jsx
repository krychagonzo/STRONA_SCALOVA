         ...
         <div className="relative z-10 w-full max-w-4xl mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20 fade-up-element">
               <div className="w-full md:w-5/12 max-w-lg">
                  ...
                  <p className="font-sans text-lg text-ivory/60 leading-relaxed">
                     Kompletne lejki i materiały domykające, które kwalifikują, przekonują i finalizują transakcje - działając autonomicznie przez całą dobę.
                  </p>
               </div>
               ...
               <div className="w-full md:w-7/12 relative flex items-center justify-center">
                  ...
                  <img src="/SEKCJA_PODEJSCIE/SPRZEDAZ.png" alt="Sprzedaż" className="w-full max-w-[200px] md:max-w-xs relative z-10" loading="lazy" />
               </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-10 md:gap-16 mb-20 fade-up-element">
               <div className="w-full md:w-5/12 max-w-lg">
                  ...
                  <p className="font-sans text-lg text-ivory/60 leading-relaxed">
                     Profesjonalna strona i spójny wizerunek cyfrowy, które budują autorytet marki - klient trafia do Ciebie już zdecydowany, zanim zdąży zapytać o cenę.
                  </p>
               </div>

               <div className="w-full md:w-7/12 relative flex items-center justify-center">
                  <div className="absolute w-72 h-72 rounded-full pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(255,255,255,0.04) 0%, transparent 70%)' }}></div>
                  <img src="/SEKCJA_PODEJSCIE/WIDOCZNOSC_W_SIECI.png" alt="Widoczność w Sieci" className="w-full max-w-[200px] md:max-w-xs relative z-10" loading="lazy" />
               </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20 fade-up-element">
               <div className="w-full md:w-5/12 max-w-lg">
                  ...
                  <p className="font-sans text-lg text-ivory/60 leading-relaxed">
                     Zintegrowany CRM i inteligentne procesy AI, które eliminują powtarzalną pracę operacyjną - Twój czas wraca tam, gdzie generuje największą wartość.
                  </p>
               </div>

               <div className="w-full md:w-7/12 relative flex items-center justify-center">
                  <div className="absolute w-72 h-72 rounded-full pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(255,255,255,0.04) 0%, transparent 70%)' }}></div>
                  <img src="/SEKCJA_PODEJSCIE/AUTOMATYZACJA.png" alt="Automatyzacje" loading="lazy" className="w-full max-w-[200px] md:max-w-xs relative z-10 translate-x-4 md:translate-x-8" />
               </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-10 md:gap-16 fade-up-element">
               <div className="w-full md:w-5/12 max-w-lg">
                  ...
                  <p className="font-sans text-lg text-ivory/60 mb-8 leading-relaxed">
                     Precyzyjne kampanie reklamowe i strategia contentowa zoptymalizowane pod stały napływ kwalifikowanych leadów przy kontrolowanym koszcie pozyskania.
                  </p>
               ...
               <div className="w-full md:w-7/12 relative flex items-center justify-center">
                  <div className="absolute w-72 h-72 rounded-full pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(255,255,255,0.04) 0%, transparent 70%)' }}></div>
                  <img src="/SEKCJA_PODEJSCIE/MARKETING.png" alt="Marketing" className="w-full max-w-[200px] md:max-w-xs relative z-10" loading="lazy" />
               </div>
            </div>
