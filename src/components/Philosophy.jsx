    ...
    <section id="proof" ref={sectionRef} className="relative w-full py-32 overflow-hidden bg-obsidian flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-24 flex flex-col items-center">
          <h2 className="fade-up-element font-heading font-bold text-4xl sm:text-5xl md:text-6xl tracking-tight text-ivory drop-shadow-md uppercase leading-[1.05]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-16 mb-40 fade-up-element">
           <div className="w-full md:w-5/12 max-w-lg">
              ...
              <h3 className="font-heading font-semibold text-5xl md:text-6xl mb-6 text-ivory drop-shadow-md uppercase">Sprzedaż</h3>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-16 md:gap-24 mb-40 fade-up-element">
           <div className="w-full md:w-5/12 max-w-lg">
              ...
              <h3 className="font-heading font-semibold text-5xl md:text-6xl mb-6 text-ivory drop-shadow-md uppercase">Widoczność w Sieci</h3>
              <p className="font-sans text-lg text-ivory/60 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-16 mb-40 fade-up-element">
           <div className="w-full md:w-5/12 max-w-lg">
              ...
              <h3 className="font-heading font-semibold text-5xl md:text-6xl mb-6 text-ivory drop-shadow-md uppercase">Automatyzacje</h3>
              <p className="font-sans text-lg text-ivory/60 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-16 md:gap-24 fade-up-element">
           <div className="w-full md:w-5/12 max-w-lg">
              ...
              <h3 className="font-heading font-semibold text-5xl md:text-6xl mb-6 text-ivory drop-shadow-md uppercase">Marketing</h3>
              ...
              <div className="flex items-center gap-6">
                 <div className="flex flex-col">
                    <span className="font-data text-3xl text-ivory font-bold">14<span className="text-accent text-xl">x</span></span>
                 ...
                 <div className="flex flex-col">
                    <span className="font-data text-3xl text-ivory font-bold">&lt;15<span className="text-accent text-xl">%</span></span>
