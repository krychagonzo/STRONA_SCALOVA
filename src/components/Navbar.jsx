...
export default function Navbar() {
  ...
  return (
    <nav
      ref={navRef}
      className="fixed top-0 left-0 right-0 z-50 w-full transition-all duration-500 text-ivory flex items-center justify-between px-8 py-3 pointer-events-none"
    >
